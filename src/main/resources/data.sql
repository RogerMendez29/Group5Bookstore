...
--added more book enteries so we can get top 10 ratings as there are only 10 books
...
VALUES
  ...
  ('3456345634563456', '10/25', '456');
   ...
   INSERT INTO Book_StoreDB.Rating (book_id, user_id, rating, timestamp)
  VALUES
  (1, 1, 5, '2024-06-01 10:00:00'),
  (2, 2, 4, '2024-06-02 11:00:00'),
  (3, 3, 3, '2024-06-03 12:00:00'),
  (4, 4, 2, '2024-06-04 13:00:00'),
  (5, 5, 1, '2024-06-05 14:00:00'),
  (1, 2, 5, '2024-06-06 15:00:00'),
  (2, 3, 4, '2024-06-07 16:00:00'),
